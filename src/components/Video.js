...
const Video = () => {
  ...
  return (
    ...
    <div className="left-side">
     <h1> Video: {currVideo + 1} out of {videos.length}</h1>
      <ReactPlayer controls url={videos[currVideo].vid} />
    </div>
      <div className="right-side">
      <textarea name="" id="input" cols="60" rows="10" onChange={handleChange} value={desc} placeholder="Write description regarding video"></textarea>
